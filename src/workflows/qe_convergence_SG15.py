...
the plane-wave cutoff and the number of k-points for a given material using SG15 PPs. 
...
# save the JSON
params_up = {"pw_conv_k": kppa, "pw_conv_cutoff": pw_cutoff}
basic_utils.update_json(id, base_dir, params_up=params_up)
